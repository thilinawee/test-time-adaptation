...
python test_time.py --cfg cfgs/imagenet_c/experiments/eata_gn_freeze.yaml \
                         ...
                         FINAL_NUM_EX 150000 \
                         RUN_NAME dogs_eata_gn_ckpt_save \
                         LOG_AVG_ACC True \
                         LOG_UNADAPTED_ACC True \
                         CKPT_SAVE_PATH /home/thilina/SSD2/thilina/test-time-adaptation-further_experiments/classification/shift_distance/ckpt/eata_gn_ckpt_save/ \
