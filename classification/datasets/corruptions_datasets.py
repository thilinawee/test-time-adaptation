...
from robustbench.loaders import CustomImageFolder, CustomCifarDataset, SelectedRotateImageFolder
...
def create_imagenetc_dataset(
    ...
    if training: 
        dataset_test = SelectedRotateImageFolder(corruption_dir_path, transform, original=True, rotation=False)
    else:
