...
class EATA_FREEZE_LR_DECAY(TTAMethod):
    ...
    We use a learning rate decay schedule for long sequence of data
    """
    ...
    def __init__(self, cfg, model, num_classes):
        ...
        # @TODO: check the condition for T_max in STAMP TTA Method
        # For 1000 classes, T_max = 1000, else T_max = 150
    ...
    def forward_and_adapt(self, x):
        if self.mixed_precision and self.device == "cuda":
            ...
            if perform_update:
                ...
                wandb.log({"train_params/lr": last_lr})
